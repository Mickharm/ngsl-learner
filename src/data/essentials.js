...
/**
 * 12 foundation units covering the closed sets a 450-word learner needs
 ...
 * prepositions, phrasal verbs and money.
 *
 ...
 */
const ESSENTIALS = [...time, ...forms, ...usage].map((u, i) => ({ ...u, order: i + 1 }))
